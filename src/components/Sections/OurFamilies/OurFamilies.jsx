...
import Poster from "../../../assets/our-families-banner.png"
      ...
      <Container>
        <Grid container alignItems='center' spacing={{xs:2, md:10}}>
            <Grid item xs={12} md={6}>
                <Typography color='primary.main' fontWeight={600}>CARING FOR THE HEALTH OF YOU AND YOUR FAMILY.</Typography>
            ...
            <Grid item xs={12} md={6}>
                <Box component='img' src={Poster} width={1} height='auto'/>
            </Grid>
        </Grid>
      </Container>
    </Box>
